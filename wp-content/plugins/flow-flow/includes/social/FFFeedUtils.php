...
class FFFeedUtils{
    ...
    public static function agoStyleDate($date){
        ...
        switch ($i) {
            case 3:
                if ($no == 1) {
                    $value = __('Yesterday', FlowFlow::$PLUGIN_SLUG);
                    break;
                }
            case 4:
            case 5:
                $value = date_i18n("M j",$date);
                break;
            case 6:
            case 7:
                $value = date_i18n("j M Y",$date);
                break;
            default:
    ...
    private static function ago($no, $cur_time, $_time, $stf, $i){
	    $phrase = array(__('s', FlowFlow::$PLUGIN_SLUG), __('m', FlowFlow::$PLUGIN_SLUG), __('h', FlowFlow::$PLUGIN_SLUG));
        $phrase = $phrase[$i];
	    ...
	    return $value . ' ' . __('ago', FlowFlow::$PLUGIN_SLUG) . ' ';
    }
    ...
    public static function classicStyleDate($date){
        ...
        if ($i > 5)
            return date_i18n("M j Y",$date);
        return date_i18n("M j H:i",$date);
    }
