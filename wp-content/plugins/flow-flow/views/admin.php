...
<ul class="section-tabs">
	<li id="streams-tab"><i class="flaticon-flow"></i> <span>Streams</span></li><li id="general-tab"><i class="flaticon-settings"></i> <span>General Settings</span></li><li id="auth-tab"><i class="flaticon-user"></i> <span>Auth Settings</span></li><li id="backup-tab"><i class="flaticon-data"></i> <span>Database</span></li><li id="request-tab"><span>Request Feature</span> <i class="flaticon-paperplane"></i></li>
</ul>
									...
									<div class="section">
										<div class="networks-choice add-feed-step">
											...
											<ul class="networks-list">
												...
												<li class="network-flickr" data-network="flickr" data-network-name="Flickr" style="margin-right:0"><i class="flaticon-flickr"></i></li><br>
							...
							<dl class="section-settings">
							    <dt>Timeline type </dt>
                   				<dd>
                            		...
                            		<label for="%uid%-list-timeline-type">User list</label>
                   				</dd>
								...
								<dd><input type="text" name="%uid%-content" placeholder="What content to stream"/>
																 ...
																 4. For user list enter username here and list name in field below
																 </p>
								</dd>
								<dt>List name</dt>
								<dd>
							...
							<dl class="section-settings">
								...
								<dd><input type="text" name="%uid%-content" placeholder="What content to stream"/>
								 <p class="desc">1. For News feed enter your own nickname to stream what you see on facebook.com<br>
																 ...
																 3. For Public page posts enter nickname of any public Facebook page eg. <strong>cnnbrkofficial</strong>
																  </p></dd>
							...
							<dl class="section-settings">
								<dt>Timeline type</dt>
                   				<dd>
                            		...
                            		<label for="%uid%-user-timeline-type">User or channel</label><br><br>
								...
								<dt class="">Content to show</dt>
								<dd class=""><input type="text" name="%uid%-content" placeholder="What content to stream"/>
								<p class="desc">1. For user feed enter YouTube username or channel ID with public access eg. <strong>VEVO</strong><br>
								2. For playlist enter playlist ID<br>
								3. For search enter any word</p>
								</dd>
							</dl>
						</div>
					',
                ...
                <dd>
                    ...
                    <input id="%uid%-search-timeline-type" type="radio" name="%uid%-timeline-type" value="tag"/>
								...
								<dd class="">
									<input type="text" name="%uid%-content" placeholder="What content to stream"/>
									<p class="desc">
										1. For user timeline enter Vine account username or ID <a target="_blank" href="http://flow.looks-awesome.com/docs/Setup/Find_Vine_ID">See instructions</a><br>
										2. For liked timeline enter Vine account username or ID <a target="_blank" href="http://flow.looks-awesome.com/docs/Setup/Find_Vine_ID">See instructions</a><br>
...
<script>
	var ff_templates = {
		...
		filterView: '<?php echo trim(preg_replace('/\s+/', ' ', $templates['filterView'])); ?>',
		...
		foursquareView : '<?php echo trim(preg_replace('/\s+/', ' ', $templates['foursquareView'])); ?>',
		vineView : '<?php echo trim(preg_replace('/\s+/', ' ', $templates['vineView'])); ?>',
		dribbbleView : '<?php echo trim(preg_replace('/\s+/', ' ', $templates['dribbbleView'])); ?>',
...
<div class="section-content" data-tab="general-tab">
	<div class="section" id="general-settings">
		...
		<dl class="section-settings">
			...
			<dt class="multiline">Disable curl option "follow location"
...
<div class="section-content" data-tab="auth-tab">
	<div class="section" id="auth-settings">
		...
		<p class="desc">Valid to pull any public Google+ page feed. <a target="_blank" href="http://flow.looks-awesome.com/docs/Setup/Authenticate_with_Google">Follow setup guide</a></p>
		<dl class="section-settings">
		...
		<h1 class="desc-following">Foursquare auth settings</h1>
		...
		<dl class="section-settings">
			...
			<dd>
				<input class="clearcache" type="text" name="flow_flow_options[foursquare_client_id]" placeholder="Copy and paste from Foursquare" value="<?php echo $options['foursquare_client_id']?>"/>
			</dd>
			<dt class="vert-aligned">Client Secret</dt>
			<dd>
				<input class="clearcache" type="text" name="flow_flow_options[foursquare_client_secret]" placeholder="Copy and paste from Foursquare" value="<?php echo $options['foursquare_client_secret']?>"/>
			</dd>
		</dl>
...
<div class="section-content" data-tab="backup-tab">
	<div class="section" id="backup-settings">
		...
		<table id="backups">
			...
			<?php
			$backups = FFSnapshotManager::get_instance()->getSnapshots();
			if (isset($backups)) {
				$count = count($backups);
