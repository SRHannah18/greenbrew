			...
			<div class="tribe-bar-views-inner tribe-clearfix">
				...
				<select class="tribe-bar-views-select tribe-no-param" name="tribe-bar-view">
					<?php foreach ( $views as $view ) : ?>
						<option <?php echo tribe_is_view($view['displaying']) ? 'selected' : 'tribe-inactive' ?> value="<?php echo $view['url'] ?>#tribe-events-content-wrapper" data-view="<?php echo $view['displaying'] ?>">
			...
			<div class="tribe-bar-filters-inner tribe-clearfix">
				...
				<?php 
					if($filter['name'] == 'tribe-bar-geoloc') {
						$filter['caption'] = 'Events in Your Area';
					}
				?>
				...
				<div class="tribe-bar-submit">
					<input class="tribe-events-button tribe-no-param" type="submit" name="submit-bar" value="<?php _e( $submit_text, 'tribe-events-calendar' ) ?>" />
