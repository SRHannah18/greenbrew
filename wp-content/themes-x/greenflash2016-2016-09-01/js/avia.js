    	...
    	var menu 			  	= header.find('.main_menu ul:eq(0)'),
			...
			{	
				...
				else
				{
					...
					mobile_advanced.insertAfter('#header');
				}
			},
			set_height = function()
			{
    ...
    function avia_hover_effect(container)
    {
	   ...
	   elements.each(function(e)
       {
            ...
            var url		 	= link.attr('href'),
				...
				if(!overlay.length)
				{
					overlay = $("<span class='image-overlay "+span_class+"'><span class='image-overlay-insid'></span></span>").appendTo(link);
				}
