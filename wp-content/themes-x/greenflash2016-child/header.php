...
<body id="top" <?php body_class($style." ".$avia_config['font_stack']." ".$blank." ".$sidebar_styling); avia_markup_helper(array('context' => 'body')); ?>>
	...
	<?php 
		...
		if(isset($avia_config['temp_logo_container'])){
  		/*
  		$logo = $avia_config['temp_logo_container'];
  		
  		$find_logo = '<img height="100" width="300" src="http://greenflashbrew.wpengine.com/wp-content/uploads/2014/01/greenflash.svg" alt="Green Flash Brewing Co.">';
  		$new_logo  = '<object type="image/svg+xml" data="/wp-content/uploads/2014/01/greenflash.svg">Your browser does not support SVGs</object>';
  		
  		$logo = str_replace($find_logo, $new_logo);
  		echo $logo; */
