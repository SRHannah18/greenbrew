					...
					$output .= "<div class='inner-container'>";
						...
						*/
						    ...
						    $output .= "<nav class='main_menu' data-selectname='".__('Select a page','avia_framework')."' ".avia_markup_helper(array('context' => 'nav', 'echo' => false)).">";
						        ...
						        /* Custom */
								$output .= "<div class='above-main-menu'><div class='partner-login-wrap mobile-hidden'><a href='#footer' class='partner-login'>Partner Login</a></div><div class='search-form'><form action='/' id='searchform' method='get'><div><input type='submit' value='Go' id='searchsubmit' class='button' /><input type='text' id='s' name='s' value='' placeholder='Search' /></div></form></div></div>";
						        $output .= $main_nav;
