...
function gfb_metaboxes( array $meta_boxes ) {
	...
	$meta_boxes[] = array(
		...
		'fields'     => array(
			...
			array(
				'name'    => __( 'Background Color Old', 'gfb' ),
				'desc'    => __( 'No Longer being used', 'gfb' ),
				'id'      => $prefix . 'bg_color',
				'type'    => 'select',
				'options' => array(
					...
					array( 'name' => __( 'Orange 3 (Soul)', 'gfb' ), 'value' => 'orange-soul', ),
					array( 'name' => __( 'Salmon (Styrian)', 'gfb' ), 'value' => 'salmon', ),
					array( 'name' => __( 'Pink (Le Freak)', 'gfb' ), 'value' => 'pink', ),
					array( 'name' => __( 'Magenta (Passion Fruit)', 'gfb' ), 'value' => 'magenta', ),
			...
			array(
				'name' => __( 'Tasting Notes Old', 'gfb' ),
				'desc' => __( 'This does nothing now', 'gfb' ),
