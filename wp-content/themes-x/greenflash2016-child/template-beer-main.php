...
if ( function_exists( 'ot_get_option' ) ) {
	...
	<?php 
		...
		<div id="genuis2" class="avia-section main_color beer-types white-text center-text thin-bar" style="background-image:url(<?php echo $genius_lab_background_image; ?>);">
			<div class="container">
			<div class="template-page content av-content-full alpha units">
