...
<ul class="tribe-events-sub-nav">
	...
	<?php if ( tribe_has_previous_event() ) : ?>
		<li class="<?php echo esc_attr( tribe_left_navigation_classes() ); ?>">
			<a class="btn btn-small" href="<?php echo esc_url( tribe_get_listview_prev_link() ); ?>" rel="prev">< &nbsp;&nbsp; Previous</a>
	...
	<?php if ( tribe_has_next_event() ) : ?>
		<li class="<?php echo esc_attr( tribe_right_navigation_classes() ); ?>">
			<a class="btn btn-small" href="<?php echo esc_url( tribe_get_listview_next_link() ); ?>" rel="next">Next &nbsp;&nbsp; ></a>
